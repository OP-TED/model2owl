...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:../../src/html-conventions-lib/association-html-conventions.xsl"/>
   ...
   <xsl:variable name="x:xspec-uri" as="xs:anyURI">file:/home/dragos/src/model2owl/test/unitTests/test-association-html-conventions.xspec</xsl:variable>
   <xsl:template name="x:main">
      ...
      <xsl:result-document format="x:report">
         ...
         <x:report stylesheet="file:../../src/html-conventions-lib/association-html-conventions.xsl"
                   date="{current-dateTime()}"
                   xspec="file:/home/dragos/src/model2owl/test/unitTests/test-association-html-conventions.xspec">
   ...
   <xsl:template name="x:d6e2">
      <xsl:message>Scenario for testing template with match 'connector[./properties/@ea_type = 'Association']-finding all associations with unmet conventions</xsl:message>
      <x:scenario>
         <x:label>Scenario for testing template with match 'connector[./properties/@ea_type = 'Association']-finding all associations with unmet conventions</x:label>
         <x:context>
   ...
   <xsl:template name="x:d6e7">
      <xsl:message>Scenario for testing template with match 'connector[./properties/@ea_type = 'Association']-finding all associations with no unmet conventions</xsl:message>
      <x:scenario>
         <x:label>Scenario for testing template with match 'connector[./properties/@ea_type = 'Association']-finding all associations with no unmet conventions</x:label>
         <x:context>
            <xsl:attribute name="href">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:attribute>
   ...
   <xsl:template name="x:d6e12">
      <xsl:message>Scenario for finding an Association that has a name</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has a name</x:label>
         <x:call>
            <xsl:attribute name="template">associationNameChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
               <xsl:attribute name="href">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:attribute>
               <xsl:attribute name="select">/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[17]</xsl:attribute>
            </x:param>
         </x:call>
         <xsl:variable name="x:result" as="item()*">
            <xsl:variable name="associationConnector-doc-uri" as="xs:anyURI">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:variable>
            <xsl:variable name="associationConnector-doc"
                          as="document-node()"
                          select="doc($associationConnector-doc-uri)"/>
            <xsl:variable name="associationConnector" as="item()*">
               <xsl:for-each select="$associationConnector-doc">
                  <xsl:sequence select="/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[17]"/>
               </xsl:for-each>
            </xsl:variable>
            <xsl:call-template name="associationNameChecker">
               <xsl:with-param name="associationConnector" select="$associationConnector"/>
            </xsl:call-template>
         </xsl:variable>
         <xsl:call-template name="test:report-sequence">
            <xsl:with-param name="sequence" select="$x:result"/>
   ...
   <xsl:template name="x:d6e16">
      <xsl:message>Scenario for finding an Association that has no name</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has no name</x:label>
         <x:call>
            <xsl:attribute name="template">associationNameChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
   ...
   <xsl:template name="x:d6e20">
      <xsl:message>Scenario for finding an Association that has a wrong direction</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has a wrong direction</x:label>
         <x:call>
            <xsl:attribute name="template">associationDirectionChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
               <xsl:attribute name="href">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:attribute>
               <xsl:attribute name="select">/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[17]</xsl:attribute>
   ...
   <xsl:template name="x:d6e24">
      <xsl:message>Scenario for finding an Association that has the right direction</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has the right direction</x:label>
         <x:call>
            <xsl:attribute name="template">associationDirectionChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
   ...
   <xsl:template name="x:d6e28">
      <xsl:message>Scenario for finding an Association that has no description</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has no description</x:label>
         <x:call>
            <xsl:attribute name="template">associationDescriptionChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
               <xsl:attribute name="href">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:attribute>
               <xsl:attribute name="select">/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[17]</xsl:attribute>
   ...
   <xsl:template name="x:d6e32">
      <xsl:message>Scenario for finding an Association that has a description</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has a description</x:label>
         <x:call>
            <xsl:attribute name="template">associationDescriptionChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
   ...
   <xsl:template name="x:d6e36">
      <xsl:message>Scenario for finding an Association that has no target role</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has no target role</x:label>
         <x:call>
            <xsl:attribute name="template">associationTargetRoleChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
               <xsl:attribute name="href">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:attribute>
               <xsl:attribute name="select">/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[17]</xsl:attribute>
         ...
         <xsl:variable name="x:result" as="item()*">
            ...
            <xsl:call-template name="associationTargetRoleChecker">
               <xsl:with-param name="associationConnector" select="$associationConnector"/>
            </xsl:call-template>
         </xsl:variable>
         <xsl:call-template name="test:report-sequence">
   ...
   <xsl:template name="x:d6e40">
      <xsl:message>Scenario for finding an Association that has a target role</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has a target role</x:label>
         <x:call>
            <xsl:attribute name="template">associationTargetRoleChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
   ...
   <xsl:template name="x:d6e44">
      <xsl:message>Scenario for finding an Association that has incorrect multiplicity value</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has incorrect multiplicity value</x:label>
         <x:call>
            <xsl:attribute name="template">associationMultiplicityChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
               <xsl:attribute name="href">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:attribute>
               <xsl:attribute name="select">/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[17]</xsl:attribute>
   ...
   <xsl:template name="x:d6e49">
      <xsl:message>Scenario for finding an Association that has a correct multiplicity value</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding an Association that has a correct multiplicity value</x:label>
         <x:call>
            <xsl:attribute name="template">associationMultiplicityChecker</xsl:attribute>
            <x:param>
               <xsl:attribute name="name">associationConnector</xsl:attribute>
