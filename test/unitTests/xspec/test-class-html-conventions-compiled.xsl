...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:variable name="x:xspec-uri" as="xs:anyURI">file:/home/dragos/src/model2owl/test/unitTests/test-class-html-conventions.xspec</xsl:variable>
   <xsl:template name="x:main">
      ...
      <xsl:result-document format="x:report">
         ...
         <x:report stylesheet="file:../../src/html-conventions-lib/class-html-conventions.xsl"
                   ...
                   xspec="file:/home/dragos/src/model2owl/test/unitTests/test-class-html-conventions.xspec">
   ...
   <xsl:template name="x:d6e15">
      <xsl:message>Scenario for finding a class name that has a description</xsl:message>
      <x:scenario>
         <x:label>Scenario for finding a class name that has a description</x:label>
         <x:call>
         ...
         <xsl:call-template name="x:d6e18">
            <xsl:with-param name="x:result" select="$x:result"/>
         </xsl:call-template>
      </x:scenario>
   </xsl:template>
   <xsl:template name="x:d6e18">
      <xsl:param name="x:result" required="yes"/>
      <xsl:message>expect to do nothing</xsl:message>
      <xsl:variable name="impl:expected" select="()"/>
      <xsl:variable name="impl:successful"
