...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:../../src/html-conventions-lib/generalization-html-conventions.xsl"/>
   ...
   <xsl:variable name="x:xspec-uri" as="xs:anyURI">file:/home/dragos/src/model2owl/test/unitTests/test-generalization-html-conventions.xspec</xsl:variable>
   <xsl:template name="x:main">
      ...
      <xsl:result-document format="x:report">
         ...
         <x:report stylesheet="file:../../src/html-conventions-lib/generalization-html-conventions.xsl"
                   date="{current-dateTime()}"
                   xspec="file:/home/dragos/src/model2owl/test/unitTests/test-generalization-html-conventions.xspec">
   ...
   <xsl:template name="x:d6e2">
      <xsl:message>Scenario for testing template with match 'connector[./properties/@ea_type = 'Generalization']-finding all generalizations with unmet conventions</xsl:message>
      <x:scenario>
         <x:label>Scenario for testing template with match 'connector[./properties/@ea_type = 'Generalization']-finding all generalizations with unmet conventions</x:label>
         <x:context>
            <xsl:attribute name="href">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:attribute>
            <xsl:attribute name="select">/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[22]</xsl:attribute>
         </x:context>
         <xsl:variable name="x:result" as="item()*">
            ...
            <xsl:variable name="impl:context" as="item()*">
               <xsl:for-each select="$impl:context-doc">
                  <xsl:sequence select="/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[22]"/>
               </xsl:for-each>
            </xsl:variable>
   ...
   <xsl:template name="x:d6e7">
      <xsl:message>Scenario for testing template with match 'element[@xmi:type = 'uml:DataType']-finding all data-types with valid names</xsl:message>
      <x:scenario>
         <x:label>Scenario for testing template with match 'element[@xmi:type = 'uml:DataType']-finding all data-types with valid names</x:label>
         <x:context>
            <xsl:attribute name="href">file:/home/dragos/src/model2owl/test/testData/ePO-CM-v2.0.1-2020-03-27_test.eap.xmi</xsl:attribute>
            <xsl:attribute name="select">/xmi:XMI/xmi:Extension[1]/connectors[1]/connector[22]</xsl:attribute>
         </x:context>
