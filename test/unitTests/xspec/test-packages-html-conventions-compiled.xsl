...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:../../src/html-conventions-lib/packages-html-conventions.xml"/>
   ...
   <xsl:variable name="x:xspec-uri" as="xs:anyURI">file:/home/dragos/src/model2owl/test/unitTests/test-packages-html-conventions.xspec</xsl:variable>
   <xsl:template name="x:main">
      ...
      <xsl:result-document format="x:report">
         ...
         <x:report stylesheet="file:../../src/html-conventions-lib/packages-html-conventions.xml"
                   date="{current-dateTime()}"
                   xspec="file:/home/dragos/src/model2owl/test/unitTests/test-packages-html-conventions.xspec">
