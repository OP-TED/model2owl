...
\label{sec:process-approach}
	...
	The main effort of the current stage of the proiject is to develop a formal ontology. This corresponds to Step \ref{step:5} of the process described in \cite[3--15]{d2.01-2017} and repeated in Section \ref{sec:context}.	
