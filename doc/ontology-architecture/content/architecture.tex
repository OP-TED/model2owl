...
%	TODO: inser the URIs
	\begin{itemize}
		\item \ptr{http://data.europa.eu/abc}
		\item \ptr{http://data.europa.eu/def}
	\end{itemize}
	...
	\begin{table}[!htb]
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{@{}ll@{}}
				\toprule
				Purpose            & Pattern                                              \\ \midrule
				Root reference     & \ptr{\{baseRes\}/resource\{documentRef\}}                 \\
				Document reference & \ptr{\{baseRes\}/resource/\{documentRef\}/\{documentRef\}} \\
				Fragment reference & \ptr{\{baseRes\}/resource/\{documentRef\}/\{fragmentRef\}{[}/\{subFragmentRef\}{]}} \\
				Resources          & \ptr{\{baseRes\}/resource/\{documentRef\}\#\{resourceId\}} \\ \bottomrule
			\end{tabular}
		}
