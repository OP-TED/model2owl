...
[source,XML]
----
<skos:ConceptScheme rdf:about="http://base.onto.uri/ControlledList">
...
<skos:Concept rdf:about="http://base.onto.uri/itemA">
  <skos:inScheme rdf:resource="http://base.onto.uri/ControlledList"/>
...
[source,XML]
----
<owl:Class rdf:about="http://base.onto.uri/ControlledList">
  <owl:equivalentClass>
    <owl:Restriction>
      <owl:onProperty rdf:resource=".../02/skos/core#inScheme"/>
      <owl:hasValue rdf:resource="http://base.onto.uri/ControlledList"/>
    </owl:Restriction>
  </owl:equivalentClass>
</owl:Class>
----
