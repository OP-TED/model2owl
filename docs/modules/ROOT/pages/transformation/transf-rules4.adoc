...
|Name |<<rule:element-label>> |<<rule:element-label>> |<<rule:element-label>>
|Note |<<rule:element-definition>> |<<rule:element-definition>> |<<rule:element-definition>>
|Comment |<<rule:element-external-comment>> |<<rule:element-external-comment>> |<<rule:element-external-comment>>
|===
...
[#rule:element-label,source,XML,caption='',title='{example-caption} {counter:rule-cnt:T.01}. Label',reftext='{example-caption} {rule-cnt}']
====
...
[#rule:element-definition,source,XML,caption='',title='{example-caption} {counter:rule-cnt:D.1}. Description',reftext='{example-caption} {rule-cnt}']
====
...
[#rule:element-external-comment,source,XML,caption='',title='{example-caption} {counter:rule-cnt:D.1}. Comment',reftext='{example-caption} {rule-cnt}']
====
